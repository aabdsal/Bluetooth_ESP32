...
static const gpio_num_t BTN_SELECT = GPIO_NUM_5;
static const gpio_num_t BTN_OK     = GPIO_NUM_4;
static const gpio_num_t BTN_RIGHT  = GPIO_NUM_17;
static const gpio_num_t BTN_LEFT   = GPIO_NUM_16;
